...
public interface ISysUserOrgDao extends IGenericDao<SysUserOrg, String> {
	/**
	 * 插入单条记录，用id作主键，把null全替换为""
	 * @param vo 用于添加的VO对象
	 * @return 若添加成功，返回新生成的id
	 */
	public int insert(SysUserOrg vo);
	 ...
	 */
	public String[] insertBatch(SysUserOrg[] vos);
	 ...
	 * @return 成功删除的记录数
	 */
	public int delete(String suo_userid);
