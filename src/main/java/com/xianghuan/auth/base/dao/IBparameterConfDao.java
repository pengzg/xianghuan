...
public interface IBparameterConfDao extends IGenericDao<BparameterConf, String> {
	/**
	 ...
	 */
	public int insert(BparameterConf vo);
	 ...
	 * @return 查询到的VO列表
	 */
	public List<BparameterConf> queryByCondition(Query query);

	/**
	 * 功能: 通过查询条件获得所有的VO对象列表
	 * 
	 * @param param
	 *            包含 queryParams 查询条件, select 等于null或""时查询全部，orderStr 排序字符
	 * @return 查询到的VO列表
	 */
