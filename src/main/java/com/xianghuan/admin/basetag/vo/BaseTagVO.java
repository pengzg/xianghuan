package com.xianghuan.admin.basetag.vo;

import com.xianghuan.auth.system.cache.SysUserCache;


public class BaseTagVO implements java.io.Serializable{
	...
	private String bt_adduserid_nameref;
	//标签状态 1-启用 0-禁用	
	...
	public String getBt_adduserid_nameref() {
		if (getBt_adduserid() != null) {
			bt_adduserid_nameref = SysUserCache.getInstance().getName(bt_adduserid+"");
		}
		return bt_adduserid_nameref;
	}

	public void setBt_adduserid_nameref(String bt_adduserid_nameref) {
		this.bt_adduserid_nameref = bt_adduserid_nameref;
	}
