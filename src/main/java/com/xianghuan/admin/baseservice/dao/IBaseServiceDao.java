package com.xianghuan.admin.baseservice.dao;
...
public interface IBaseServiceDao extends IGenericDao<BaseService, String> {
	/**
	 * 插入单条记录，用id作主键，把null全替换为""
	 * @param vo 用于添加的VO对象
	 * @return 若添加成功，返回新生成的id
	 */
	public int insert(BaseService vo);
	 ...
	 * @return 查询到的VO列表
	 */
	public List<BaseService> queryByCondition(Query query);
	public List<BaseServiceVO> queryByConditionExt(Query query);
