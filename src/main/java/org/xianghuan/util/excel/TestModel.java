...
public class TestModel {
	...
	private String type1;//刷卡手续费方式
	private BigDecimal pay1;//刷卡手续费
	private String type2;//积分手续费方式
	private BigDecimal pay2;//积分手续费
	private String type3;//固定金额方式
	private BigDecimal pay3;//固定金额手续费
