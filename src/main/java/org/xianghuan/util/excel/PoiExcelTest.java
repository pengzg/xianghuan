...
/*		// 获取Excel文件的sheet列表
		...
		//testReadExcel("c:/test.xlsx", 0, "1-", new String[] {"a","b","c","d","e"});
	...
	// 测试Excel读取
	private static void testReadExcel(String filePath, int sheetIndex, String rows, String[] columns) throws IllegalAccessException, InvocationTargetException, InstantiationException {
		ImportiExcelUtil helper = getPoiExcelHelper(filePath);
		...
		//List<Object> list  = bulidbyProperty(TestModel.class, new String[] {"merchantid","type1","pay1","type2","pay2"}, dataList);
		System.out.println();
		/*for(Object l : list) {
