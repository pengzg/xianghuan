...
public abstract class ScaleImageUtils {
    ...
    public static void main(String[] args) throws ImageFormatException, MalformedURLException, IOException {
        ...
        File file = new File("D:\\workspace1\\sqkxboxui\\Community-box\\static\\upload\\2017\\01\\19\\1484815756773093140.png");
        ScaleImageUtils.resizeByHeight(100, "C:\\12345.png",file );
    }
}
