package org.xianghuan.jdbc.sql.builder;
...
import org.xianghuan.jdbc.sql.annotation.FieldMapper;
import org.xianghuan.jdbc.sql.annotation.FieldMapperAnnotation;
import org.xianghuan.jdbc.sql.annotation.TableMapper;
import org.xianghuan.jdbc.sql.annotation.TableMapperAnnotation;
import org.xianghuan.jdbc.sql.annotation.UniqueKeyType;
...
public class SqlBuilder {
     ...
     * @throws Exception
     */
    public static String buildInsertSqlWithValue(Object object) throws Exception {
        if (null == object) {
     ...
     * @throws Exception
     */
    public static String buildUpdateSqlWithValue(Object object) throws Exception {
        if (null == object) {
            throw new RuntimeException("Sorry,I refuse to build sql for a null object!");
        }
        Map dtoFieldMap = PropertyUtils.describe(object);
     ...
     * @throws Exception
     */
    public static String buildDeleteSqlByUniqueKey(Object object) throws Exception {
        if (null == object) {
            throw new RuntimeException("Sorry,I refuse to build sql for a null object!");
        }
        Map dtoFieldMap = PropertyUtils.describe(object);
     ...
     * @throws Exception
     */
    public static String buildSelectSqlByUniqueKey(Object object) throws Exception {
        if (null == object) {
            throw new RuntimeException("Sorry,I refuse to build sql for a null object!");
        }
        Map dtoFieldMap = PropertyUtils.describe(object);
     ...
     * @throws Exception
     */
    public static String buildSelectSql(Class<?> dtoClass) throws Exception {
        if (null == dtoClass) {
            throw new RuntimeException("Sorry,I refuse to build sql for a null object!");
        }
        TableMapper tableMapper = buildTableMapper(dtoClass);
        TableMapperAnnotation tma = (TableMapperAnnotation) tableMapper.getTableMapperAnnotation();
        String tableName = tma.tableName();
        StringBuffer selectSql = new StringBuffer();
        selectSql.append("select ");
        ...
        selectSql.delete(selectSql.lastIndexOf(","), selectSql.lastIndexOf(",") + 3);
        selectSql.append(" from ").append(tableName).append(" where dr=0 ");
     ...
     * @throws Exception
     */
	public static String buildInsertSql(Class<?> dtoClass) throws Exception {
		if (null == dtoClass) {
			throw new RuntimeException("Sorry,I refuse to build sql for a null object!");
		}
		TableMapper tableMapper = buildTableMapper(dtoClass);
     ...
     * @throws Exception
     */
    public static String buildUpdateSql(Class<?> dtoClass) throws Exception {
        if (null == dtoClass) {
            throw new RuntimeException("Sorry,I refuse to build sql for a null object!");
        }
        TableMapper tableMapper = buildTableMapper(dtoClass);
