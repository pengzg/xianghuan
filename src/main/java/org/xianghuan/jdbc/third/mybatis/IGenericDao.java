...
public abstract interface IGenericDao<T, PK extends Serializable> {  
     ...
     */  
	public abstract int update(DynamicSqlParameter param) throws Throwable;
     ...
     */  
	public abstract T find(PK primaryKey);
  
    /** 
     * 按主键取记录 
     * @param primaryKey 主键值 
     * @return 记录实体对象，如果没有符合主键条件的记录，则 throw Throwable 
     */  
    public abstract T load(PK primaryKey) throws Throwable;  
     ...
     */  
	public abstract DataGrid<T> selectPagination(DynamicSqlParameter param);
     ...
     * @return PaginationResult对象，包括（符合条件的）总记录数、页实体对象List等 
     */  
	public abstract DataGrid<T> selectFkPagination(DynamicSqlParameter param);
