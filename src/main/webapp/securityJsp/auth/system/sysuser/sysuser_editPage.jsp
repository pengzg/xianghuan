...
<script type="text/javascript">
	$(function() {
		initAreaCombox('${bean.su_procice}','${bean.su_city}','${bean.su_district}',true);
		...
		<fieldset>
			...
			<table class="table">
				...
				<tr>
					...
					<th>所在城市</th>
					<td colspan="3">
				        <select id="area_1" name="su_procice"></select>
				        <select id="area_2" name="su_city"></select>
				        <select id="area_3" name="su_district"></select>
			        </td>
				</tr>					
				<tr>
					<th>有效开始日期</th>
