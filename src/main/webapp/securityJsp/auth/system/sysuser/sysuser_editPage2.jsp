...
<script type="text/javascript">
	...
	$(function() {
		...
		if (id) {
			...
			$('#su_role').combobox('setValue','2');
			$('#su_sex').combobox('setValue','2');
			var dateTime = getNowDate();
			$("#su_startdate").datebox('setValue',dateTime);
			$('#su_status').combobox('setValue',1);
		}
			...
			<table class="table">
				...
				<tr>
					...
					<td>
						...
						data-options="required:false,editable:false,idField:'id',textField:'text',parentField:'pid',
				...
				<tr>
					...
					<td>
						...
						data-options="url:'${pageContext.request.contextPath}/base/baseDataControl/detailItem.action?codekey=2017',
						valueField:'bd_code',textField:'bd_name', editable:false, required:true" />
					</td>
					<th>状态</th>
					<td>
