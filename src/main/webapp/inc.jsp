...
<script src="<%=contextPath%>/jslib/ueditor1_4_3-utf8-jsp/ueditor.config.js" type="text/javascript" charset="utf-8"></script>
<script src="<%=contextPath%>/jslib/ueditor1_4_3-utf8-jsp/ueditor.all.min.js" type="text/javascript" charset="utf-8"></script>
<script src="<%=contextPath%>/jslib/ueditor1_4_3-utf8-jsp/lang/zh-cn/zh-cn.js" type="text/javascript" charset="utf-8"></script>
...
<script src="<%=contextPath%>/jslib/sqkxComboExt.js?version=<%=version%>" type="text/javascript" charset="utf-8"></script>
<%-- 引入Highcharts --%>
...
<%-- 引入公共弹出页面 --%>
<script type="text/javascript" src="<%=contextPath%>/jsp/ref/showWindows.js?time=1"></script>
<script type="text/javascript" src="<%=contextPath%>/jsp/ref/initCombo.js"></script>
<script type="text/javascript" src="<%=contextPath%>/jslib/moneyFormat/common.js"></script>
<script type="text/javascript" src="<%=contextPath%>/jslib/moneyFormat/commonDetail.js"></script>
<script type="text/javascript" src="<%=contextPath%>/jslib/moneyFormat/commonUtil.js"></script>
...
<!-- 引入文件上传插件 -->
<script type="text/javascript" src="<%=contextPath%>/jslib/ajaxfileupload/ajaxfileupload.js" charset="utf-8"></script>


<script type="text/javascript" src="<%=contextPath%>/jsp/ref/validate.js"></script>
<script type="text/javascript" src="<%=contextPath%>/jsp/ref/fileupload.js"></script>
<script type="text/javascript" src="<%=contextPath%>/jslib/uploadPreview/uploadPreviewExt.js" charset="utf-8"></script>

<!-- 打开新标签 -->
<script type="text/javascript" src="<%=contextPath %>/jslib/openNewTab.js"></script>
